    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        <div className="relative">
          <input
            ...
            className="w-full px-6 py-3 rounded-lg focus:outline-none focus:border-purple-500 transition-colors bg-[var(--gray-900)] border border-[var(--gray-700)] text-white"
          />
      ...
      <div className="flex flex-wrap items-center gap-3 mb-6">
        ...
        <select
          ...
          className="px-3 py-1.5 rounded-lg text-sm bg-[var(--gray-900)] border border-[var(--gray-700)] text-[var(--gray-400)] focus:outline-none focus:border-purple-500 cursor-pointer"
        >
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <button
            ...
            className="px-6 py-2 rounded-lg font-medium transition-colors bg-purple-600 text-white hover:bg-purple-700 cursor-pointer"
          >
            Clear filters
          </button>
        </div>
