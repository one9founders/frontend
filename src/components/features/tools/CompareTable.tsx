...
export default function CompareTable({ tools, onRemoveTool }: CompareTableProps) {
  ...
  const getPricingDisplay = (tool: Tool) => {
    ...
    if (tool.pricing_from) return { text: `From $${tool.pricing_from}/mo`, color: 'text-orange-600' };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-orange-100 to-amber-50 rounded-lg p-6 border border-orange-200">
                    ...
                    <td key={tool.id} className="p-4">
                      <div className="text-center">
                        {tool.integrations?.length ? (
                          <>
                            <span className="text-orange-600 font-semibold">{tool.integrations.length}+</span>
                            <div className="flex flex-wrap gap-1 justify-center mt-2">
                  ...
                  <td key={tool.id} className="p-4 text-center">
                    <div className="space-y-2">
                      <a
                        ...
                        className="w-full py-2.5 px-4 bg-orange-600 text-white rounded-lg hover:bg-orange-700 text-sm font-medium flex items-center justify-center gap-2 transition-colors"
                      >
