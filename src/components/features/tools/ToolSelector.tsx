    ...
    <div className="mb-8">
      <div className="bg-[var(--gray-900)] rounded-lg p-6">
        ...
        <input
          ...
          className="w-full px-4 py-2 mb-4 bg-[var(--gray-800)] text-white rounded-lg border border-[var(--gray-700)] focus:border-blue-500 focus:outline-none"
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-h-96 overflow-y-auto">
          {filteredTools.slice(0, 12).map((tool) => (
            <div
              ...
              className="flex items-center gap-3 p-3 bg-[var(--gray-800)] rounded-lg cursor-pointer hover:bg-[var(--gray-700)] transition-colors"
            >
              <img
