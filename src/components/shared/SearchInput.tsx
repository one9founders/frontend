    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      <div className="relative">
        <input
          ...
          autoComplete="off"
          className="w-full px-6 py-4 text-lg rounded-lg focus:outline-none focus:border-orange-500 transition-colors bg-[var(--gray-900)] border border-[var(--gray-700)] text-[var(--gray-600)]"
        />
