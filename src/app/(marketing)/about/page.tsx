...
export const metadata: Metadata = generateSEO({
  ...
  description: 'India\'s largest AI ecosystem navigator. 26,000+ tools, 177 LLMs, 1,200+ agents rated with our 10-point security framework. Supported by IIT Bombay.',
  path: '/about',
