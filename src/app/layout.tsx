...
export const metadata: Metadata = {
  ...
  description: `Discover ${STATS.totalResources} AI tools, ${STATS.aiAgents} agents, ${STATS.llmsCompared} LLMs, and ${STATS.researchPapers} research papers. Compare pricing, benchmarks, and security ratings. Built for startup founders.`,
  keywords: ['AI tools directory', 'AI tools for startups', 'security validated AI tools', 'unbiased AI tool reviews', 'compare AI tools India', 'startup tools', 'founder resources', 'AI research papers'],
